<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="ResetPass.aspx.vb" Inherits="ResetPass" %>
                ...
                <td width="100%" style="padding-bottom: 150px;">
                    ...
                    <div align="center" id="login">
                        <table id="tableMainForm" cellpadding="0" cellspacing="0" border="0">
                            <tbody>
                            <tr><h4 id="page-title" >
                                Nhập Window User và Window Password (Tài khoản dùng để đăng nhập vào máy tính của User cần reset mật khẩu BTS).Ví dụ: syhieuvt/Abc1@3456</h4></tr>
                                <tr>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="line-height: 100%;">
                                                                <asp:TextBox CssClass="loginInput"  ID="txtUserName" runat="server"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="line-height: 100%; padding-top: 10px;">
                                                                <span class="btn inform" style="padding-left: 6px;"><i class="login" style="margin-right: 10px;">
                                                                    ...
                                                                    <asp:Button Style="margin-top: 6px; background-color: #fff;" CssClass="btn inform"
                                                                        ID="btnCancel" Text="Cancel" runat="server" OnClick="btnCancel_Click" OnClientClick="HandleMessage(this)" />  
                                                                </span>
                                                            </td> 
