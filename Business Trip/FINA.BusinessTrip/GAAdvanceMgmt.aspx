<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="GAAdvanceMgmt.aspx.vb"
    Inherits="GAAdvanceMgmt" MasterPageFile="~/MasterPage.Master" %>
    ...
    <div class="ui-accordion ui-widget ui-helper-reset ui-hidden-container" role="tablist">
        <div id="panGetInfo" class="no-transition">
            ...
            <div class="tab-container">
                <h3 class="ui-accordion-header ui-helper-reset ui-state-default ui-state-active ui-corner-top active"
                    role="tab">
                    <span class="ui-icon"></span>GA Request Infomation</h3>
                <div class="ui-accordion-content ui-helper-reset ui-widget-content" role="tabpanel">
                                ...
                                <div class="HRTabList">
                                    <div class="HRTab">
                                        <div class="bt-legend" style="float: right; padding: 5px 0 10px;">
                                            <strong>BTS Legend:</strong> <span class="ora-not-found" style="padding: 0 5px; border-right: 1px solid #ccc;">
                                                Pending</span> <span class="ora-done" style="padding: 0 5px;">Budget Checked</span>
                                        </div>
                                        <div style="clear: both">
                                        </div>
                                            ...
                                            <ContentTemplate>
                                                <dx:ASPxGridView ID="grvBTRegister" KeyFieldName="BTRegisterID" runat="server" Theme="Office2010Black"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataColumn Width="25px" FieldName="GAStatus" Caption="" Visible="false" />
                                                        ...
                                                        <dx:GridViewDataColumn Width="100px" FieldName="Destination" Caption="Destination" />
                                                        <dx:GridViewDataColumn FieldName="RequestGA" Caption="Request to GA" />
                                                        <dx:GridViewDataImageColumn Width="20px" CellStyle-HorizontalAlign="Left">
                                                            <DataItemTemplate>
                                                                ...
                                                                <input type="button" class="grid-btn approval-btn <%# If(Eval("GAStatus").ToString() = GAStatus.rejected.ToString(), "hide", "") %>"
                                                                    onclick="confirmApproval(this)" title="Approve" />
                                                                <input type="button" class="grid-btn reject-btn <%# If(Eval("GAStatus").ToString() = GAStatus.rejected.ToString(), "hide", "") %>"
                                    ...
                                    <div class="HRTab">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                                            <ContentTemplate>
                                                <dx:ASPxGridView ID="grvBTNoRequest" KeyFieldName="BTRegisterID" runat="server" Theme="Office2010Black"
                                                    AutoGenerateColumns="false">
                                                    <SettingsText EmptyDataRow="No records found!" />
                                                    <Settings ShowFilterRow="true" ShowFilterRowMenu="true" />
                                                    <SettingsPager PageSize="100" NumericButtonCount="10">
                                            ...
                                            <ContentTemplate>
                                                <dx:ASPxGridView ID="grvBTSubmitted" KeyFieldName="BTRegisterID" ClientInstanceName="grvBTSubmitted"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataColumn Width="100px" FieldName="Destination" Caption="Destination" />
                                                        <dx:GridViewDataColumn FieldName="RequestGA" Caption="Request to GA" />
                                                        <dx:GridViewDataImageColumn Width="20px">
                                                            <DataItemTemplate>
                                                                <asp:Button ID="btnView" runat="server" ToolTip="View" CssClass="grid-btn viewDetails-btn"
                                                                    data-id='<%# Eval("BTRegisterID") %>' OnClientClick="btnViewBTClick(this); HandleMessage($('[id$=btnSearch]')[0]); bindStartupEvent();"
                                                                    OnClick="btnView_OnClick"></asp:Button>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="ScriptPlaceHolder">
    ...
    <script src="/js/ga-advance-mgmt.js" type="text/javascript"></script>
