<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BTAirTicketRequest.aspx.vb"
    Inherits="BTAirTicketRequest" MasterPageFile="~/MasterPage.Master" %>
            ...
            <div class="ui-accordion-content ui-helper-reset ui-widget-content default-hide"
                ...
                <div class="ui-datatable ui-widget">
                    <div class="HRTabControl">
                        ...
                        <div class="HRTabList">
                            <div class="HRTab">
                                <%--Buttons--%>
                                <div runat="server" id="btnShowAddOtherAirTicket" style="float: left; margin-top: 5px">
                                            ...
                                            <dx:ASPxGridView ID="grvPrepared" runat="server" KeyFieldName="ID" Theme="Office2010Black"
                                                ...
                                                <Columns>
                                                    ...
                                                    <dx:GridViewDataImageColumn Width="40px" CellStyle-HorizontalAlign="Left">
                                                        <DataItemTemplate>
                                                            <asp:Button ID="btnEdit" runat="server" ToolTip="View/Edit" CssClass='grid-btn edit-btn'
                                                            ...
                                                            <asp:Button ID="btnDelete" data-id='<%# Eval("ID") %>' ToolTip="Delete" runat="server"
                                                                CssClass="hide" OnClick="btnDeleteOtherAirTicket_OnClick" OnClientClick="HandleMessage($('[id$=btnSearch]')[0]); bindStartupEvents($('[id$=btnSearch]')[0])">
                                                            </asp:Button>
                                                        </DataItemTemplate>
                ...
                <fieldset class="add-edit-form" id="OtherAirTicketForm">
                    ...
                    <asp:UpdatePanel ID="upAirTicketRequest" runat="server">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="ui-panelgrid-cell" style="width: 100px">
                                            <label>
                                                From Country<span class="required">*</span></label>
                                        </td>
                                        <td class="ui-panelgrid-cell validate-required">
                                    ...
                                    <tr>
                                        <td class="ui-panelgrid-cell" style="width: 100px">
                                            <label>
                                                To Country<span class="required">*</span></label>
                                        </td>
                                        <td class="ui-panelgrid-cell validate-required">
                                    ...
                                    <tr>
                                        ...
                                        <td class="ui-panelgrid-cell validate-required">
                                            <asp:TextBox ID="txtRequestBudgetCode" CssClass="hr-budgetcode" runat="server"></asp:TextBox>
                                        </td>
                                        <td class="ui-panelgrid-cell">
                                            <label>
                        ...
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="btnSaveOtherAirTicket" />
                        </Triggers>
                    </asp:UpdatePanel>
                    ...
                    <div class="action-pan">
                        <asp:UpdatePanel ID="UpdatePanel9" runat="server">
                            <ContentTemplate>
                                ...
                                <span runat="server" id="btnShowSubmit" visible="false">
                                    <input type="button" value="Submit to GA" class="btn" onclick="showSubmitMessage()" /></span>
                                <span runat="server" id="btnConfirmRecall" visible="false">
                                    <input type="button" value="Recall" class="btn attention" onclick="ConfirmRecall()" />
                                </span>
                                <asp:Button ID="btnRecall" runat="server" Visible="false" Text="Recall" Style="text-align: center;"
                                    CssClass="btn attention hide" OnClientClick="HandleMessage($('[id$=btnSearch]')[0]); bindStartupEvents($('[id$=btnSearch]')[0]);" />
                                ...
                                <tr>
                                    <td style="padding: 5px 30px 15px;">
                                        <h3 style="margin: 0; padding: 5px 0 3px; background-color: #fff; border-bottom: 1px solid #999;">
                                            Submit to GA to check request</h3>
...
<asp:Content ID="ScriptContent" runat="server" ContentPlaceHolderID="ScriptPlaceHolder">
    ...
    <script type="text/javascript">
        var _budgetCodes = <%= GetBudgetCodes() %>      
    </script>
