<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="BTOneDayDeclaration.aspx.vb"
    Inherits="BTOneDayDeclaration" MasterPageFile="~/MasterPage.Master" %>
...
<asp:Content ID="TitleContent" runat="server" ContentPlaceHolderID="TitlePlaceHolder">
    One Day Trip Advance Management
</asp:Content>
<asp:Content ID="MainContent" runat="server" ContentPlaceHolderID="MainContentPlaceHolder">
        ...
        <div id="panRegister" class="no-transition" style="display: none;">
            ...
            <div class="tab-container">
                ...
                <div class="ui-accordion-content ui-helper-reset ui-widget-content" role="tabpanel"
                                ...
                                <div>
                                    ...
                                    <table style="background-color: #f9f9f9; margin: 0;">
                                        <tr>
                                            ...
                                            <th style="border: 1px solid #ccc; padding: 5px 5px">
                                                Request to GA
                                            </th>
                                        </tr>
                                        <tr>
                    ...
                    <%--Common--%>
                    <span id="btnAddRequest" style="margin-top: 15px; text-align: center;" class="btn inform add-btn"
                                    ...
                                    <dx:ASPxGridView ID="grvBTRequest" runat="server" KeyFieldName="RequestID" Theme="Office2010Black"
                                        ...
                                        <Columns>
                                            <dx:GridViewDataColumn Width="25px" Settings-AllowAutoFilter="False" FieldName="No"
                                                Caption="No" />
                                            <dx:GridViewDataDateColumn FieldName="FromDate" Caption="Date" Width="90px" PropertiesDateEdit-DisplayFormatString="{0:dd-MMM-yyyy}" />
                                            ...
                                            <dx:GridViewDataImageColumn Width="40px">
                                                <DataItemTemplate>
                                                    ...
                                                    <asp:Button ID="btnDelete" data-id='<%# Eval("RequestID") %>' ToolTip="Delete" runat="server"
                                                ...
                                                <fieldset style="width: 98%; padding: 0; border: none; margin: 10px 0;">
                                                    <table class="grid-inside" style="margin-top: 0; table-layout: fixed">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding: 5px !important;">
                                                                <%#Eval("MotobikeAmount", "{0:#,0.##}")%>
                                                            </td>
                                                            <td style="padding: 5px !important; background-color: #eee;">
                                                                <%#Eval("TotalTransportation", "{0:#,0.##}")%>
                                                            </td>
                                                            <td style="padding: 5px !important;">
                                                                <%#Eval("MovingTimeAllowance", "{0:#,0.##}")%>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </fieldset>
                                ...
                                <table class="ui-panelgrid ui-widget grid-edit" role="grid">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="ui-panelgrid-cell date-time-picker validate-required">
                                                <dx:ASPxDateEdit TabIndex="1" ID="dteDate" runat="server" ClientInstanceName="dteDate"
                                            ...
                                            <td class="ui-panelgrid-cell date-time-picker time-picker schedule-time">
                                                <dx:ASPxTimeEdit TabIndex="2" Style="width: 100px !important; display: inline-block"
                                                    ID="txeFromTime" runat="server" DisplayFormatString="HH:mm" EditFormatString="HH:mm"
                                                    ClientSideEvents-DateChanged="BTDateChanged" AutoPostBack="false" ClientInstanceName="txeFromTime">
                                                ...
                                                <dx:ASPxTimeEdit TabIndex="3" Style="width: 100px !important; display: inline-block"
                                                    ID="txeToTime" runat="server" DisplayFormatString="HH:mm" EditFormatString="HH:mm"
                                                    ClientSideEvents-DateChanged="BTDateChanged" AutoPostBack="false" ClientInstanceName="txeToTime">
                                                    <ValidationSettings ErrorDisplayMode="None" />
                                                </dx:ASPxTimeEdit>
                                                ...
                                                <div class="request-container">
                                                    <table class="tblRequestDetails grid-inside grid-normal">
                                                        <tr>
                                                            ...
                                                            <td style="text-align: center">
                                                                <asp:CheckBox runat="server" AutoPostBack="false" onchange="CalculateRequest(true)"
                                                        ...
                                                        <tr class="amount hide">
                                                            ...
                                                            <td class="td-input">
                                                                <dx:ASPxSpinEdit ID="txtBreakfastUnit" TabIndex="9" ClientInstanceName="txtBreakfastUnit"
                                                            ...
                                                            <td class="td-input">
                                                                <dx:ASPxSpinEdit ID="txtLunchUnit" TabIndex="11" ClientInstanceName="txtLunchUnit"
                                                            ...
                                                            <td class="td-input">
                                                                <dx:ASPxSpinEdit ID="txtDinnerUnit" TabIndex="13" ClientInstanceName="txtDinnerUnit"
                                                                    runat="server" Height="21px" MinValue="0" MaxValue="1000000000000" NumberType="Float"
                                                                    NullText="0" DecimalPlaces="2" DisplayFormatString="{0:#,0.##}" SpinButtons-ShowIncrementButtons="false"
                                                                    ReadOnly="true">
                                                                </dx:ASPxSpinEdit>
                                        ...
                                        <tr>
                                            ...
                                            <td class="ui-panelgrid-cell date-time-picker">
                                                <dx:ASPxDateEdit TabIndex="23" ID="dteRequestDate" ClientInstanceName="dteRequestDate"
    ...
    <div id="next-container" class="action-pan no-transition">
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                <asp:Button ID="btnAdd" runat="server" Text="Add" CssClass="btn hide" OnClientClick="bindStartupEvents(this); HandleMessage(this); btnAdd_Click()" />
...
<asp:Content ID="ScriptContent" runat="server" ContentPlaceHolderID="ScriptPlaceHolder">
    ...
    <script src="/js/bt-oneday-register.js" type="text/javascript"></script>
