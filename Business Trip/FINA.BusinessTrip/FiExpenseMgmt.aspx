<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FiExpenseMgmt.aspx.vb"
    Inherits="FiExpenseMgmt" MasterPageFile="~/MasterPage.Master" %>
...
<asp:Content ID="Content1" runat="server" ContentPlaceHolderID="TitlePlaceHolder">
    FI Expense management
</asp:Content>
<asp:Content ID="MainPart" runat="server" ContentPlaceHolderID="MainContentPlaceHolder">
    <%--Preload images--%>
    ...
    <div class="ui-accordion ui-widget ui-helper-reset ui-hidden-container" role="tablist">
        <div id="panGetInfo" class="no-transition">
                                    ...
                                    <tr>
                                        <td align="center" colspan="4">
                                            <span class="btn inform" style="margin-left: 3px; top: 20px; text-align: center;">
                                                <asp:Button ID="btnSearch" CssClass="btnSearch" runat="server" Text="" OnClientClick="HandleMessage(this); bindStartupEvent()" />
            ...
            <div class="tab-container">
                <h3 class="ui-accordion-header ui-helper-reset ui-state-default ui-state-active ui-corner-top active"
                    role="tab">
                    <span class="ui-icon"></span>Expense Infomation</h3>
                <div class="ui-accordion-content ui-helper-reset ui-widget-content" role="tabpanel">
                                        ...
                                        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                            <ContentTemplate>
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataImageColumn Width="60px" CellStyle-HorizontalAlign="Left">
                                                            <DataItemTemplate>
                                                                ...
                                                                <input type="button" class="grid-btn approval-btn <%# If(Eval("FIStatus").ToString() = FIStatus.rejected.ToString() OrElse (Provider.CommonFunction._ToInt(Eval("IsOneDayExpense")) = 1 AndAlso Eval("FIStatus").ToString() <> FIStatus.checked.ToString()), "hide", "") %>"
                                                                ...
                                                                <input type="button" class="grid-btn reject-btn <%# If(Eval("FIStatus").ToString() = FIStatus.rejected.ToString() OrElse (Provider.CommonFunction._ToInt(Eval("IsOneDayExpense")) = 1 AndAlso Eval("FIStatus").ToString() <> FIStatus.checked.ToString()), "hide", "") %>"
                                                ...
                                                <%--<div id="next-container" visible="false" class="action-pan hide">
                                                    <asp:Button runat="server" Text="Approve" OnClientClick="HandleMessage($('[id$=btnSearch]')[0]); bindStartupEvent()"
    ...
    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
        <ContentTemplate>
            <div id="tabApproveMessage" runat="server" class="popup-container">
                ...
                <input type="button" id="btnInvoiceDateChange" onclick="HandleMessage($('[id$=btnSearch]')[0]); bindStartupEvent();"
                    class="hide" />
                <asp:Button runat="server" ID="btnCheckExtInvoice" CssClass="hide" OnClientClick="HandleMessage(this); bindStartupEvent();" />
                <table style="width: 100%; height: 100%; margin: 0;">
                    <tr>
                        <td style="vertical-align: middle; border: none !important; padding: 0 !important;">
                            <table class="grid-edit" style="width: auto !important; margin: auto; background-color: #fff;
                                ...
                                <tr runat="server" id="trExtensionInvoice" visible="false">
                                    ...
                                    <td style="padding: 10px 30px 15px 5px; border-top: 1px solid #ccc !important; border-bottom: 1px solid #ccc !important;"
                                        ...
                                        <dx:ASPxSpinEdit ID="spiExtensionExrate" runat="server" MinValue="1" MaxValue="1000000000000"
                                            NumberType="Integer" NullText="0" DisplayFormatString="{0:#,0.##}" Increment="100">
                                        </dx:ASPxSpinEdit>
                                    </td>
                                </tr>
...
<asp:Content ID="Script" runat="server" ContentPlaceHolderID="ScriptPlaceHolder">
    ...
    <script src="/js/fi-expense-mgmt.js" type="text/javascript"></script>
