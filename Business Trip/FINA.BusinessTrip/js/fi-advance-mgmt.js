...
function confirmApproval(me) {
    ...
    $.ajax({
        ...
        if (isOverBudget) {
            showApproveMessage(me, "It seem to be Over Budget! Do you want to continue?")
        }
...
function showApproveMessage(me, message) {
